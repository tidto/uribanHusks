...
<body>
	<div class="alert alert-info layer" id="done" role="alert">
		<div class="iq-alert-text cnf align-self-center">과제가 수정됐습니다</div>
		<div>
	...
	<div class="card">
		<div class="card-body">
			<div class="d-flex justify-content-start breadcrumb-content">
				<h5><span>${myClass.schoolName}</span> <span>${myClass.grade}학년</span> <span>${myClass.classes}반</span>  과제수정</h5>
			</div>
		</div>
	</div>
	<div class="card">
		<div class="card-body">
			<form name="updateForm" action="homeworkUpdate?${_csrf.parameterName}=${_csrf.token}" method="post">
		    ...
		    <!-- 과제 삽입 구분 선 -->
		    <ul class="nav nav-tabs justify-content-end" id="myTab-4" role="tablist"> </ul>
		    <div class="form-row float-right" id="delBtn">
		    	<button type="button" class="btn btn-warning mt-2"><i class="ri-delete-bin-2-fill pr-0">삭제</i></button>
		    </div>
		    <!-- 과제 삽입 및 보기 -->
			<div class="container-fluid">
			        <div class="row" id="testList">
			    	    <c:forEach items="${testBank}" var="test">
		    				<div class="col-md-6 col-lg-4 col-sm-6 testDiv">
								<div class="card">
					                ...
					                <c:if test="${empty test.testImg}">
				                  		<img src="../assets/images/page-img/07.jpg" class="card-img-top" alt="#">
							  		</c:if>
								  
				                  	<c:if test="${not empty test.testImg}">
				                  		<img src="../testBank/img/${test.testImg}" class="card-img-top" alt="#">
				              		</c:if>
					                <div class="card-body">
							                <div class="input-group mb-4">
								                <div class="input-group-prepend">
								                ...
								                <input type="text" class="form-control" aria-label="Username"
								                   aria-describedby="basic-addon1" value="${test.testScore}" readonly>
											</div>
						                   <div class="input-group mb-4">
						                     <div class="input-group-prepend">
						                     ...
						                     <input type="text" class="form-control" aria-label="Username"
						                        aria-describedby="basic-addon1" value="${test.testDetail}" readonly>
						                  </div>
						                  <c:forEach items="${test_answer}" var="bogi">
							                  <div class="input-group mb-4">
							                     <div class="input-group-prepend">
							                        <span class="input-group-text" id="basic-addon1">보기</span>
							                     </div>
							                     <input type="text" class="form-control" aria-label="Username"
							                        aria-describedby="basic-addon1" value="${bogi.testAnswer}" readonly>
							                  </div>
						                  </c:forEach>
						                  <div class="input-group mb-4">
						                     <div class="input-group-prepend">
						                     ...
						                     <input type="text" class="form-control" aria-label="Username"
						                        aria-describedby="basic-addon1" value="${test.testCorrect}" readonly>
						                  </div>
					                </div>
					             </div>
				          	</div>
			        ...
			        <!-- 추가 문제 -->
			           ...
			           <!-- 입력과제 -->
		           		<div class="col-sm-6 col-md-6 col-lg-3" name="addTestBlock">
		               		<div class="card card-block card-stretch card-height">
		                  		<div class="card-body" id="newTest">
		                     		<div class="subscriber-detail text-center">
		                        		<button type="button" class="mt-2 btn btn-link" name="addTest"><i class="ri-bill-fill">과제를 추가하세요</i></button>
		                     		</div>
		                  		</div>
		               		</div>
		            	</div>
			        ...
			        <div class="modal-content">
			          ...
			          <div class="modal-body">
				          <span id="start-one">
				             ...
				             <button type="button" name="direct_test" id="file-upload-btn" class="btn btn-primary">직접출제</button>
				          </span>
			          </div>
			          <div class="modal-body">
				          <span id="start-one">
				             <i class="fa fa-download" aria-hidden="true"></i>
				             <button type="button" name="test_select" id="file-upload-btn" class="btn btn-primary">문제선택</button>
				          </span>
			          </div>
...
<!-- 						주관식 정답 -->
						<div class="input-group mb-4" name="writeAnswer">
							...
							<input type="text" class="form-control" name="testCorrect"
								placeholder="단답식 답 입력" aria-label="단답식 답 입력"
								aria-describedby="basic-addon1">
						</div>

						<div class="input-group mb-2" name="explainAnswer">
							<div class="input-group-prepend">
								<span class="input-group-text" id="basic-addon1">문제해설</span>
							</div>
							<input type="text" class="form-control" name="testCommentary"
								placeholder="해설" aria-label="해설" aria-describedby="basic-addon1">
						</div>
					</div>
					<div class="modal-footer">
