...
<div class="card">
   ...
   <div class="d-flex justify-content-center">
      <div class="col-sm-12 col-lg-9">
         <div class="card">
            <div class="card-body">
               <form id="insertForm" name="insertForm" action="../album/albumInsert?${_csrf.parameterName}=${_csrf.token}" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                <div class="form-group">
                   <label for="content">내용</label>
                   <input type="text" class="form-control" id="content"
                      name="content" maxlength="100" placeholder="내용을 입력해주세요">
                </div>
                <div class="form-group">
                   <label for="place">장소</label>
                   <input type="text" class="form-control" id="place"
                     name="place" maxlength="50" placeholder="장소를 입력해주세요">
                </div>
                <div class="form-group">
				...
				<div class="d-flex justify-content-end">
	                ...
	                <button type="button" class="btn bg-danger" onclick="location.href='../album/albumList'">취소</button>
	            </div>
