											...
											<div class="px-3 pt-0 pb-0 sub-card">
												<a href="#" class="iq-sub-card">
													<div
														...
														<div class="">
															<img class="avatar-50 rounded-small"
																src="${pageContext.request.contextPath }/myassets/images/user/01.jpg"
																alt="01">
														</div>
													...
													<div
														...
														<div class="">
															<img class="avatar-50 rounded-small"
																src="${pageContext.request.contextPath }/myassets/images/user/02.jpg"
																alt="02">
														</div>
														<div class="media-body ml-3">
															<div
													...
													<div class="media align-items-center cust-card py-3">
														<div class="">
															<img class="avatar-50 rounded-small"
																src="${pageContext.request.contextPath }/myassets/images/user/03.jpg"
																alt="03">
														</div>
														<div class="media-body ml-3">
															<div
