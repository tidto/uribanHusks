					...
					<div class="card-body" style="min-height:85vh">
						<div class="card mb-3">
							<div class="card-body">
								<div class="row">
									<div class="col-lg-12">
										<h4 class="mb-2">우리반 톡 -> <strong id="line">받은 톡 보기</strong></h4>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="email-right-box">
							<div role="toolbar" class="toolbar">
								<c:if test="${!empty mailReceiveList }">
									<div class="btn-group">
							...
							<input type="hidden" id="mailReceiver" 	name="mailReceiver" value="${p.memberId }">
							<input type="hidden" id="senderId" 		name="senderId"		value="${p.memberId }">
							
							<div class="email-list m-t-15" data-receive_mail_no="${rl.mailReNo }">
								<div class="message">
									<a href="../mail/mailReceiveInfo?mailReNo=${rl.mailReNo }&readCheck=${rl.readCheck}">
										<div class="col-mail col-mail-1">
											...
											<c:if test="${rl.readCheck eq 'F201' }">
										...
										<!-- 읽음/안읽음 구분 -->
											<c:choose>
												<c:when test="${rl.readCheck eq 'F201'}">
													<!-- 메일 제목 -->
													<div class="subject">
														<strong> &#91;${rl.mailTypeName }&#93; ${rl.receiveTitle}</strong>
													</div>
													<!-- 시간 MM:dd HH:mm -->							
													<div class="date">
														<strong>
												...
												<c:otherwise>
													<!-- 메일 제목 -->
													<div class="subject">
														 &#91;${rl.mailTypeName }&#93; ${rl.receiveTitle}
													</div>
													<!-- 시간 MM:dd HH:mm -->							
													<div class="date">
														<fmt:formatDate value="${rl.receiveDate }" pattern="MM.dd HH:mm" />
			    ...
			    selectedCheckboxes.forEach((checkbox) => {
			        ...
			        .done(result =>{
						if (result >= 0) {
	                    	...
	                    	$('.layera').hide();
	                    	$('.dones').text('선택하신 우리반 톡/받은 톡이 삭제되었습니다.');
							$('#dones').show();
							setTimeout(function(){
								$('.layer1').hide();
							}, 1600)
