		...
		<div class="row">
				...
				<div class="card">
					...
					<div class="card-body">
						<form>
							...
							<a href="#" class="btn btn-primary">내게 쓰기</a>
							<hr>
			...
			<div class="col-xl-10 col-lg-8">
				<div class="card">
					<div class="card-header d-flex justify-content-between">
						<div class="header-title">
							<h4 class="card-title">우리반 톡 작성란</h4>
						</div>
					</div>
					<div class="card-body">
						<div class="new-user-info">
							<form>
								<div class="row">
									...
									<!-- 교사에게만 보이게 / 학생 부모는 해당 클래스 선생으로 고정 -->
									<div class="form-group col-md-12">
										<label>우리반 명단</label> 
										<select name="type" class="selectpicker form-control" data-style="py-0">
											<option value="">---받을 클래스원 선택---</option>
											<optgroup label="학생명단">
											<option value="아이디">학생명(아이디)</option>
											</optgroup>
											<optgroup label="보호자명단">
											<option value="아이디">보호자명(아이디)</option>
											</optgroup>
										</select>
									</div>
									...
									<div class="form-group col-md-6">
										<label for="">톡 유형 </label> 
										<select name="type" class="selectpicker form-control" data-style="py-0">
											<option value="">---톡 유형 선택---</option>
											<optgroup label="학생에게..">
											<option value="F102">마음의 편지 답변</option>
											</optgroup>
											<optgroup label="보호자께..">
											<option value="F103">개별알림</option>
											<option value="F101">상담 답변</option>
											</optgroup>
										</select>
									</div>
									...
									<!-- 제목 -->
									<div class="form-group col-md-12">
										<label for="">톡 제목 </label> 
										<input type="text" class="form-control" name="mailTitle"
											id="cname" placeholder="보내실 톡 제목을 작성해주세요.">
									</div>
									
									<!-- 내용 -->
									<div class="form-group col-md-12">
										<label for="validationTextarea">공지사항 내용</label>
										<textarea rows="13" class="form-control was-invalid" name="mailContents"
											id="validationTextarea" placeholder="보내실 톡 내용을 작성해주세요."
								...
								<!-- 선생 체크박스 -->
								<p class="mb-0">선택하신 톡 유형에 반하는 내용이나 학급 내를 벗어난 개인적 발언을 학생 또는 학부모께 했을 경우 제재가 가해질 수 있습니다.</p>
								<!-- 학생/학부모 체크박스 -->
								<p class="mb-0">선택하신 톡 유형과 반하는 내용이나 공격적인 발언, 지속적인 응답을 선생님께 요구할 경우 제재가 가해질 수 있습니다. </p>
								
								<div class="checkbox">
									<label><input class="mr-2" type="checkbox" name="promiseChecked">
										네, 지키겠습니다.
									</label>
								</div>
								<button type="submit" class="btn btn-primary">톡 보내기</button>
							</form>
						</div>
					</div>
				</div>
