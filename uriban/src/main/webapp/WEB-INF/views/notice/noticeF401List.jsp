				...
				<div class="card">
					<div class="card-body">
						<div class="d-flex flex-wrap align-items-center justify-content-between breadcrumb-content">
							<h5>우리 반 &#60;가정통신문&#62; 게시판</h5>
							<div class="d-flex flex-wrap align-items-center">
								<c:if test="${p.authority eq 'ROLE_A102' }">
									<a href="../notice/noticeF401Insert" class="btn btn-primary">새 가정통신문 등록하기</a>
								</c:if>
							</div>
						</div>
					</div>
					...
					<div class="card-body">
						<div class="row">
							...
							<c:if test="${ empty noticeList }">
								<h1>우리반 가정통신문 공지가 없습니다</h1>
							</c:if>
							<c:forEach items="${noticeList }" var="nl"  varStatus="status"> 
							<div class="noticeitems">
								<div class="card card-widget task-card" id="taskCard${nl.noticeNo}">
									<div class="card-body">
								...
								<div class="collapse<c:if test="${param.noticeNo eq nl.noticeNo}"> show</c:if>" id="collapseEdit${status.count }">
									<div class="card card-list task-card" data-notice_no="${nl.noticeNo }">
										<div
											...
											<div class="header-title">
												<h5 class="mb-2">제목: ${nl.noticeTitle }</h5>
...
// 				// 어노테이션(./notice) put(수정)delete(삭제)
// 				// $.ajax('../notice/' + noticeNo,{ 데이터를 따로 필요로 하지않음
// 				// type : 'delete' 
