									...
									<form>
										...
										<div class=" row align-items-center">
											<div class="form-group col-sm-12">
												<label for="fname">아이디</label> ${memberInfo.memberId} <input type="text"
											...
											<div class="form-group col-sm-12">
												<label for="uname">연락처</label> <input type="text"
													class="form-control" id="phone" value="${memberInfo.phone}"
													readonly="readonly">
											</div>
											<div class="form-group col-sm-12">
												<label for="cname">메일</label> <input type="text"
													class="form-control" id="email" value="${memberInfo.email}" readonly="readonly">
											</div>
											<div class="form-group col-sm-12">
